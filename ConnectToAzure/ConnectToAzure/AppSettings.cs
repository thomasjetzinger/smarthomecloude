...
namespace ConnectTheDotsIoT
{
    ...
    public class AppSettings
    {
        ...
        const string ServicebusNamespaceDefault = "jtiotsuite-servicebus";
        const string EventHubNameDefault = "jteventhub";
        const string KeyNameDefault = "RootManageSharedAccessKey";
        const string KeyDefault = "bKATWplCM5meVyFb8fnjxBhv";
        const string DisplayNameDefault = "Cloud Comouting";
        const string OrganizationDefault = "FH Hagenberg";
        const string LocationDefault = "AUT";
